...
public class DetailProduit extends BaseForm {
    ...
    public DetailProduit () {
        this(com.codename1.ui.util.Resources.getGlobalResources()   , Product.class );
    }
    public DetailProduit (com.codename1.ui.util.Resources resourceObjectInstance  , Product product) {
    ...
    public DetailProduit (Resources globalResources, Class<Product> productClass) {
        super ();
    }

    // <editor-fold defaultstate="collapsed" desc="Generated Code">
    private void initGuiBuilderComponents(com.codename1.ui.util.Resources resourceObjectInstance , Product product) {
...
//image ****************************************************
        ...
        fab.addActionListener(e -> {
           ...
           // cr.deleteProduct (Integer.toString(product.getId ()));
            if(cr.deleteProduct (Integer.toString(product.getId ()))!=null){
                Dialog.show("le Produit "+product.getName ()+" a été supprimé","", "voir tout les produit", null);
