...
public class DetailPost extends BaseForm {
    ...
    public DetailPost () {
        this(com.codename1.ui.util.Resources.getGlobalResources()   , Post.class );
    }
    public DetailPost (com.codename1.ui.util.Resources resourceObjectInstance  , Post product) {
    ...
    public DetailPost (Resources globalResources, Class<Post> productClass) {
        super ();
    }

    // <editor-fold defaultstate="collapsed" desc="Generated Code">
    private void initGuiBuilderComponents(com.codename1.ui.util.Resources resourceObjectInstance , Post product) {
        ...
        URLImage urlImg =URLImage
                .createToStorage(placeHolder,product.getUser (), product.getImage());
        img.setImage(urlImg);
        urlImg.fetch();
...
//image ****************************************************
        ...
        gui_LA.setName("LA");
        gui_LA.setPropertyValue("line1", product.getCreatedAt ());
        gui_LA.setPropertyValue("line2", "Disponible");
        gui_LA.setPropertyValue("uiid1", "SlightlySmallerFontLabel");
        gui_LA.setPropertyValue("uiid2", "Price" + product.getContent ());
        ...
        gui_Text_Area_1.setText(product.getUpdatedAt ());
        ...
        fab.addActionListener(e -> {
            CrudPost cr = new CrudPost ();
            // cr.deleteProduct (Integer.toString(product.getId ()));
            if(cr.deletePost (product.getId ())!=null){
                Dialog.show("le Produit "+product.getContent ()+" a été supprimé","", "voir tout les produit", null);
