...
public class AjoutCategory extends BaseForm {
    ...
    public AjoutCategory() {
        this(com.codename1.ui.util.Resources.getGlobalResources());
    }
    public AjoutCategory(com.codename1.ui.util.Resources resourceObjectInstance) {
        initGuiBuilderComponents(resourceObjectInstance);

        getToolbar().setTitleComponent(
                FlowLayout.encloseCenterMiddle(
                        new Label ("Ajouter une Category", "Title"),
        ...
        fab.addActionListener(e -> {
            ...
            cr.addCategory (gui_Text_Area_1.getText () , gui_Text_Area_1_1.getText ()); //,  "http://res.cloudinary.com/will-team-genie/image/upload/v1563705301/symfony-listing/a27wijty543ikoiemvqz.png", "1" ,  gui_Text_Area_1_2.getText (),  gui_Text_Area_1_3.getText ());
            Dialog.show("la Categorie "+gui_Text_Area_1.getText ()+" a été ajouté","", "voir tout les produit", null);

            new CategoryForm ().getF2 ().show();
        });
    }
    ...
    protected void initGuiBuilderComponents(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        gui_Label_3.setText("Nom de Categorie");
        gui_Label_3.setName("Label_3");
        gui_Label_2.setText("name");
        gui_Label_2.setUIID("RedLabel");
        gui_Label_2.setName("Label_2");
        gui_Text_Area_1.setText("tapez pour modifie le nom du Categorie");
        gui_Text_Area_1.setEditable ( true );
        ...
        gui_Label_3_1.setText("Description du Categorie");
        ...
        gui_Text_Area_1_1.setText("tapez pour modifie la description du Categorie");
        gui_Text_Area_1_1.setEditable ( true );
