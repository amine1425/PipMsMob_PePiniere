...
public class FlashSaleDetails extends BaseForm {
    ...
    public FlashSaleDetails () {
        this(com.codename1.ui.util.Resources.getGlobalResources(),FlashSale.class);
    }
    public FlashSaleDetails (Resources globalResources, Class<FlashSale> productClass) {
        super ();
    }
    public FlashSaleDetails (com.codename1.ui.util.Resources resourceObjectInstance  , FlashSale product) {
    ...
    private void initGuiBuilderComponents(com.codename1.ui.util.Resources resourceObjectInstance , FlashSale product) {
...
//image ****************************************************
        ...
        gui_LA.setName("LA");
        gui_LA.setPropertyValue("line1", product.getName ());
        ...
        fab.addActionListener(e -> {
            ...
            if(cr.deleteFlashSale (Integer.toString(product.getId ()))!=null){
                Dialog.show("FlashSale "+product.getName ()+" a été supprimé","", "voir tout les FlahSale", null);

                FlashSaleForm af = new FlashSaleForm ();
                af.getF2 ().show ();
