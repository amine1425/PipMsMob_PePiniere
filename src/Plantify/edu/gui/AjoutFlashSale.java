...
public class AjoutFlashSale extends BaseForm {
    ...
    public AjoutFlashSale() {
        this(com.codename1.ui.util.Resources.getGlobalResources());
    }
    public AjoutFlashSale(com.codename1.ui.util.Resources resourceObjectInstance) {
        initGuiBuilderComponents(resourceObjectInstance);

        getToolbar().setTitleComponent(
                FlowLayout.encloseCenterMiddle(
                        new Label ("Ajouter FlashSale", "Title"),
        ...
        fab.addActionListener(e -> {
            FlashSaleService cr = new FlashSaleService ();
            //String name,String description, String image , String price
            cr.addFlashSale (gui_Text_Area_1.getText () , gui_Text_Area_1_1.getText (),  "http://res.cloudinary.com/will-team-genie/image/upload/v1563705301/symfony-listing/a27wijty543ikoiemvqz.png",  gui_Text_Area_1_2.getText () );
            Dialog.show("FlashSale \n "+gui_Text_Area_1.getText ()+" \na été ajouté","", "voir tout les FlashSale", null);

            new FlashSaleForm ().getF2 ().show();
        });
    }
    ...
    protected void initGuiBuilderComponents(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        gui_Label_3.setText("Nom de FlashSale");
        gui_Label_3.setName("Label_3");
        gui_Label_2.setText("name");
        gui_Label_2.setUIID("RedLabel");
        gui_Label_2.setName("Label_2");
        gui_Text_Area_1.setText("tapez pour modifie le nom du FlashSale");
        gui_Text_Area_1.setEditable ( true );
        ...
        gui_Label_3_1.setText("Description du FlashSale");
        ...
        gui_Text_Area_1_1.setText("tapez pour modifie la description du FlashSAle");
        gui_Text_Area_1_1.setEditable ( true );
        ...
        //addComponent(gui_Container_1_3); -------------------------------------------------------------------------- ne pas ajouter quantity
       ...
       // addComponent(gui_Container_1_4); ------------------------------------------------------------------------------------------- ne pas ajouter image
