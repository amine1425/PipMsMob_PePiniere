...
public class WalkthruForm extends com.codename1.ui.Form {
    ...
    public WalkthruForm(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        Image bla = resourceObjectInstance.getImage("image1.png");
        Image griffith = resourceObjectInstance.getImage("image2.png");
        Image learn = resourceObjectInstance.getImage("image3.jpg");

        gui_tab1Root.setLayout(new BorderLayout());
        gui_tab2Root.setLayout(new BorderLayout());
        gui_tab3Root.setLayout(new BorderLayout());

        String line1 = "Welcome to Plantify.it the\nmost popular when its subjects of\nplants and garden's ...";
        ...
        Container content1 = BoxLayout.encloseY(
                new Label("Welcome in Plantify.it", "WelcomeTitle"),
